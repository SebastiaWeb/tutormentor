...
function Login() {
    ...
    const handleButtonClick = () => {
      navigate('/dashboard'); // Navegar a la ruta /about
    };
    ...
    return (<>
        <div className="container">
            ...
            <section className="position-relative container mt-5 z-2">
                <div className="w-90 py-5 ps-4 pe-4 formulario-desing conedor-centrado formulario-desing-login">
                    <div className="container py-5 ps-4 pe-4">
                        ...
                        {Object.entries(camposForm).map((campo, index) => {
                            ...
                            return (<div className="d-lg-flex py-4 justify-content-center " style={{flexDirection: "column"}} key={index}>
                                {Object.entries(camposArray).map((elements, keys2) => {
                                    ...
                                    if (element.type == "text" || element.type == "password" || element.type == "number" || element.type == "email" || element.type == "date") {
                                        return (<Input name={element.label} type={element.type} placeholder={element.placeholder} key={keys2} col="col-lg-12"/>)
                    ...
                    <div>
                        <button class="w-100 p-3" onClick={handleButtonClick}>Login</button>
                    </div>
                </div>
